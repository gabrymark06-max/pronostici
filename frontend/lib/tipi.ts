...
/* ------------------------------------------------------------------ */
/* ledger/{stagione}.jsonl — una riga per pronostico pubblicato        */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* odds_budget.json — dichiarazione di trasparenza, mostrata in chiaro */
/* ------------------------------------------------------------------ */
...
export interface BudgetQuote {
  ...
  degradation_step: string | number | null;
